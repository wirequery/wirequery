...
class EntryService(
    ...
    fun getEntries(accountId: String): List<Entry> {
        val products: Map<String, Product> = productsClient
    ...
    fun addToBasket(accountId: String, productId: String, quantity: Int) {
    ...
    fun removeFromBasket(accountId: String, productId: String) {
        if (accountToProductIdToQuantity[accountId] == null) {
            return
        }
